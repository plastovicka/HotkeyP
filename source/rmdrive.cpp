...
int removeDrive1(char DriveLetter)
{
...
{
  HMODULE lib = LoadLibrary("setupapi.dll");
  if(lib){
  ...
  FreeLibrary(lib);
  if(!fCM_Request_Device_EjectW) msg("Remove drive function requires Windows 2000 or later");
}
